...
import { Header, OurStoryDescription, Paragraph } from './our-story.style';
  ...
  return (
    <>
      ...
      <OurStoryDescription>
        ...
        <Paragraph style={{ lineHeight: '2.5em' }}>
          Little Chic is your go-to online marketplace for stylish second-hand children's clothing.
          We started with a simple idea: kids grow fast, but their clothes shouldn't cost a fortune
          or end up in landfills. As a mom, I wanted to dress my daughter in cute, quality outfits
          ...
          – you're joining a community of savvy parents who value both style and sensibility.
          Whether you're buying or selling, you're part of a movement that's making kids' fashion
          more accessible and eco-friendly. Little Chic: Where little fashionistas and smart
          budgeting meet!
        </Paragraph>
      </OurStoryDescription>
    </>
